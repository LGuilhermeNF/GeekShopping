    ...
    public class DbInitializer : IDbInitializer
    {
        ...
        public void Initialize()
        {
            ...
            ApplicationUser admin = new ApplicationUser()
            {
                ...
                Email = "guilherme-admin@erudio.com.br",
                EmailConfirmed = true,
            ...
            _user.CreateAsync(admin, "Guilherme$123").GetAwaiter().GetResult();
            ...
            _user.CreateAsync(client, "Guilherme$123").GetAwaiter().GetResult();
